...
import com.billing.service.BeginnerWorkoutService;
...
/**
 * REST controller for managing {@link com.billing.domain.BeginnerWorkout}.
 */
@RestController
@RequestMapping("/api")
public class BeginnerWorkoutResource {
    ...
    private static final String ENTITY_NAME = "trainBeginnerWorkout";
