...
import com.billing.repository.WorkoutStepRepository;
import com.billing.service.WorkoutStepService;
...
/**
 * REST controller for managing {@link com.billing.domain.WorkoutStep}.
 */
@RestController
@RequestMapping("/api")
public class WorkoutStepResource {
    ...
    private static final String ENTITY_NAME = "trainWorkoutStep";
