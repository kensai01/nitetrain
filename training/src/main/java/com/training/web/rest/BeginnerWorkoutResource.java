...
import com.training.service.BeginnerWorkoutService;
...
/**
 * REST controller for managing {@link com.training.domain.BeginnerWorkout}.
 */
@RestController
@RequestMapping("/api")
public class BeginnerWorkoutResource {
    ...
    private static final String ENTITY_NAME = "trainingBeginnerWorkout";
    ...
    public List<BeginnerWorkoutDTO> getAllBeginnerWorkouts() {
