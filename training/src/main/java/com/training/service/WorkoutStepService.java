...
public class WorkoutStepService {
    ...
    public List<WorkoutStepDTO> findAll() {
        log.debug("Request to get all WorkoutSteps");
        return workoutStepRepository.findAll().stream().map(workoutStepMapper::toDto).collect(Collectors.toCollection(LinkedList::new));
    }
