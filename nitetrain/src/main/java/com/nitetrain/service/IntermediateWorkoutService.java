...
public class IntermediateWorkoutService {
    ...
    public Flux<IntermediateWorkoutDTO> findAll(Pageable pageable) {
        log.debug("Request to get all IntermediateWorkouts");
        return intermediateWorkoutRepository.findAllBy(pageable).map(intermediateWorkoutMapper::toDto);
    }
